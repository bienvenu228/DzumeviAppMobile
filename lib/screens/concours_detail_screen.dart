...
class _ConcoursDetailScreenState extends State<ConcoursDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.concours.titre, style: const TextStyle(fontWeight: FontWeight.bold)),
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            if (candidats.isEmpty) {
              return const Center(child: Text("Aucun candidat inscrit", style: TextStyle(fontSize: 18)));
            }
